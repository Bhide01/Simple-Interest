...
ra=Label(root, text="Rate:", font= "calibri 15")
...
interest = Label(root,text="Time:", font= "calibri 15")
...
raentry =Entry(root, textvariable=ravalue, font="courier 20", width=8)

prentry.place(x=200, y=20)
sientry.place(x=200, y=90)
raentry.place(x=200, y=160)
